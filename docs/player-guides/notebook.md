...
![Default Notebook](/img/notebook/default.png){: style="display:block; margin:0 auto;"}
...
![Removing notebook pages](/img/notebook/trash.png){: style="display:block; margin:0 auto;"}
